...
class TarefaList(Resource):
    @jwt_required
    # JWT Required autenticação de token requirido para esse recurso.
    def get(self):
        """
    ...
    def post(self):
        ...
        if validate:
            ...
            dt_expiracao = request.json["dt_expiracao"]
            ...
            tarefa_nova = tarefa.Tarefa(titulo=titulo, descricao=descricao,
                                        dt_expiracao=dt_expiracao, projeto=projeto_tarefa)
...
class TarefaDetail(Resource):
    ...
    def get(self, id):
        ...
        if tarefa is None:
            return make_response(jsonify("Tarefa not found!!"), 404)
        ts = tarefa_schema.TarefaSchema()
    ...
    def delete(self, id):
        ...
        return make_response('', 204)  # Removido com sucesso!!
